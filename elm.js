...
Elm.ReactNative.ReactNative.make = function (_elm) {
       ...
       var property = $Native$ReactNative.property;
       ...
       var string = $Native$ReactNative.stringNode;
       var node = $Native$ReactNative.node;
       var view = node("React.View");
       var text = F2(function (props,textContent) {
                     return A3(node
                              ,"React.Text"
                              ,props
                              ,_U.list([string(textContent)]));
                  });
       var image = F2(function (props,source) {
                      return A3(node
                               ,"React.Image"
                               ,A2($List._op["::"],imageSource(source),props)
                               ,_U.list([]));
                   });
       var Property = {ctor: "Property"};
       var VTree = {ctor: "VTree"};
          ...
          var normalUpdate = F2(function (maybeAction,model) {
                                ...
                                if (_p0.ctor === "Just") {
                                   ...
                                   return _U.crashCase("ReactNative.NativeApp"
                                                      ,{start: {line: 42,column: 7},end: {line: 47,column: 50}}
